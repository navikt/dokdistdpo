...
import no.nav.dokdistdpo.qdist015.dokdistforsendelse.OppdaterForsendelse;
...
import static no.nav.dokdistdpo.qdist015.Qdist015Service.PROPERTY_CONVERSATION_ID;
import static no.nav.dokdistdpo.qdist015.Qdist015Service.PROPERTY_FORSENDELSE_ID;
...
public class Qdist015Route extends RouteBuilder {
	...
	public Qdist015Route(
			Queue qdist015,
			Queue qdist015FunksjonellFeil,
			Queue qdist009,
	...
	public void configure() throws Exception {
		...
		from(SEND_TIL_PRINT)
				...
				.process(new MdcHeaderProcessor())
				.marshal(new JaxbDataFormat(newInstance(DistribuerForsendelse.class)))
	...
	public static String getIdsForLogging() {
		return "konversasjonId=${exchangeProperty." + PROPERTY_CONVERSATION_ID + "}, " +
