...
import static no.nav.dokdistdpo.consumer.dpo.dokumentpakke.avtaltmelding.AvtaltStandardBusinessDocumentMapper.DOKUMENTIDENTIFICATION_TYPE_AVTALTMELDING;
import static no.nav.dokdistdpo.consumer.dpo.dokumentpakke.avtaltmelding.AvtaltStandardBusinessDocumentMapper.SCOPE_MESSAGECHANELL_IDENTIFIER;
import static no.nav.dokdistdpo.consumer.dpo.dokumentpakke.avtaltmelding.AvtaltStandardBusinessDocumentMapper.TYPE_VERSION;
