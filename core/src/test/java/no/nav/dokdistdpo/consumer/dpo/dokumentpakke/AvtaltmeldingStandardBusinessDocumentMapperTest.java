...
import static no.nav.dokdistdpo.consumer.dpo.dokumentpakke.AvtaltmeldingStandardBusinessDocumentMapper.DOKUMENTIDENTIFICATION_TYPE_AVTALTMELDING;
...
class AvtaltmeldingStandardBusinessDocumentMapperTest {

	private final AvtaltmeldingStandardBusinessDocumentMapper mapper = new AvtaltmeldingStandardBusinessDocumentMapper();
