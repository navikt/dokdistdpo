...
public class Altinn3BrokerMapper {
	...
	private Map<String, String> mapPropertyList(AltinnDpoRequest altinnDpoRequest) {
		...
		propertyList.put(ScopeType.CONVERSATION_ID.getFullname(), altinnDpoRequest.forsendelse().konversjonsId());
		propertyList.put(ScopeType.BESTILLINGS_ID.getFullname(), altinnDpoRequest.forsendelse().bestillingsId());
