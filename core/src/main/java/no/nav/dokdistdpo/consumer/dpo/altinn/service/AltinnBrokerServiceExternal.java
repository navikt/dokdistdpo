package no.nav.dokdistdpo.consumer.dpo.altinn.service;
...
import no.nav.dokdistdpo.consumer.dpo.altinn.to.AltinnResonFactory;
import no.nav.dokdistdpo.consumer.dpo.altinn.to.SearchCriteria;
import no.nav.dokdistdpo.consumer.dpo.altinn.to.ServiceCode;
