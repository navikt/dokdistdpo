...
public class JmsConfig {
	...
	@Bean
	public Queue qdist015FunksjonellFeil(@Value("${dokdistdpo_qdist015_funk_feil.queuename}") String qdist015FunkFeilQueueName) throws JMSException {
		return new MQQueue(qdist015FunkFeilQueueName);
	}
